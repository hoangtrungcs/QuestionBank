...
namespace HtmlEditorExtend.Features
{
    public static class HtmlEditingCommands
    {
        ...
        /// <summary>
        /// LeeTrung:Insert Seperate manual to document
        /// </summary>
        public static RoutedUICommand InsertSeperate { get { return _insertSeperate; } }
        /// <summary>
        /// 插入超链接命令
        /// </summary>
        ...
        static RoutedUICommand _insertSeperate = new RoutedUICommand();
