...
namespace EnglishQuestion.MainApp.Controls.Compose
{
    ...
    /// </summary>
    public partial class ListeningQA : ComposeBasePage, IComposeBase
    {
        ...
        public ListeningQA(TestLevel level, LevelSection section)
        {
            InitializeComponent();
            Level = level;
            Section = section;
            ...
            //var paragraphs = GetParagraph(Level.ToString().GetSubTypeFromTestLevel(), QuestionType.LQA.ToString());
        ...
        public void Insert()
        {
            ...
            m_pageViewModel.Insert(CreateParagraph(Level.ToString().GetSubTypeFromTestLevel(), Section.ToString(),
                                   QuestionLevel.Normal.ToString(), QuestionPurpose.All.ToString(), desFile, QuestionType.LQA.ToString()));
