...
namespace EnglishQuestion.MainApp.Controls.Compose
{
    ...
    /// </summary>
    public partial class ReadingPA : ComposeBasePage, IComposeBase
    {
        ...
        public ReadingPA(TestLevel level, LevelSection section)
        {
            InitializeComponent();
            Level = level;
            Section = section;
            ...
            //var paragraphs = GetParagraph(Level.ToString().GetSubTypeFromTestLevel(), QuestionType.RPA.ToString());
        ...
        public void Insert()
        {
            m_pageViewModel.Insert(CreateParagraph(Level.ToString().GetSubTypeFromTestLevel(), Section.ToString(),
                QuestionLevel.Normal.ToString(), QuestionPurpose.All.ToString(), string.Empty, QuestionType.RPA.ToString()));
